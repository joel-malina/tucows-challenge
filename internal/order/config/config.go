...
type ServiceConfig struct {
	...
	BasePath    string `env:"BASE_PATH" envDefault:"/order" envDocs:"The base path for the REST api"`
	ServiceName string `env:"SERVICE_NAME" envDefault:"order" envDocs:"The name of the service"`
